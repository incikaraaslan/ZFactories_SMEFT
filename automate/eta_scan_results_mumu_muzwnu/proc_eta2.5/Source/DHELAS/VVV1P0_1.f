...
C     
     ...
     $ * W1))
      V1(3)= DENOM*(TMP12*(-CI*(P2(0))+CI*(P3(0)))+(V2(3)*(-CI*(TMP7)
     $ +CI*(TMP8))+V3(3)*(+CI*(TMP9)-CI*(TMP11))))
      V1(4)= DENOM*(TMP12*(-CI*(P2(1))+CI*(P3(1)))+(V2(4)*(-CI*(TMP7)
     $ +CI*(TMP8))+V3(4)*(+CI*(TMP9)-CI*(TMP11))))
      V1(5)= DENOM*(TMP12*(-CI*(P2(2))+CI*(P3(2)))+(V2(5)*(-CI*(TMP7)
     $ +CI*(TMP8))+V3(5)*(+CI*(TMP9)-CI*(TMP11))))
      V1(6)= DENOM*(TMP12*(-CI*(P2(3))+CI*(P3(3)))+(V2(6)*(-CI*(TMP7)
