...
C     
      SUBROUTINE FFVV17_0(F1, F2, V3, V4, COUP,VERTEX)
      IMPLICIT NONE
      COMPLEX*16 CI
      ...
      COMPLEX*16 V4(*)
      COMPLEX*16 VERTEX
      TMP19 = (F1(3)*(F2(3)*(V3(3)*(V4(3)+V4(6))+(V3(4)*(-1D0)*(V4(4)
     ...
     $ -1D0)*(+CI*(V4(4))+V4(5))+V3(6)*(V4(3)-V4(6)))))))
      TMP20 = (F1(3)*(F2(3)*(V3(3)*(V4(3)-V4(6))+(V3(4)*(-V4(4)+CI
     ...
     $ *(V3(3)*(V4(3)-V4(6))+(V3(4)*(-1D0)*(V4(4)+CI*(V4(5)))+(V3(5)*(
     $ +CI*(V4(4))-V4(5))+V3(6)*(V4(3)-V4(6)))))))
      VERTEX = COUP*(-CI*(TMP19+TMP21)+CI*(TMP20+TMP22))
      END
