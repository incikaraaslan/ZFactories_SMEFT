...
C     
      ...
      V2(3)= COUP*(V1(3)*(-1D0)*(+CI*(TMP2+TMP3))+(+CI*(P1(0)*TMP4
     $ +V3(3)*TMP6)))
      V2(4)= COUP*(V1(4)*(+CI*(TMP2+TMP3))+(-CI*(P1(1)*TMP4+V3(4)*TMP6)
     $ ))
      V2(5)= COUP*(V1(5)*(+CI*(TMP2+TMP3))+(-CI*(P1(2)*TMP4+V3(5)*TMP6)
     $ ))
      V2(6)= COUP*(V1(6)*(+CI*(TMP2+TMP3))+(-CI*(P1(3)*TMP4+V3(6)*TMP6)
     $ ))
      END
