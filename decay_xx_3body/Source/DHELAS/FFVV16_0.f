...
C     
      SUBROUTINE FFVV16_0(F1, F2, V3, V4, COUP,VERTEX)
      IMPLICIT NONE
      COMPLEX*16 CI
      ...
      COMPLEX*16 V4(*)
      COMPLEX*16 VERTEX
      TMP21 = (F1(5)*(F2(5)*(V3(3)*(V4(3)-V4(6))+(V3(4)*(-1D0)*(V4(4)
     ...
     $ -1D0)*(+CI*(V4(4))+V4(5))-V3(6)*(V4(3)+V4(6)))))))
      TMP22 = (F1(5)*(F2(5)*(V3(3)*(V4(3)+V4(6))+(V3(4)*(-V4(4)+CI
...
C      Gamma(3,-2,-1)*Gamma(4,2,-2)*ProjP(-1,1)
C     
      SUBROUTINE FFVV16_9_0(F1, F2, V3, V4, COUP1, COUP2,VERTEX)
      IMPLICIT NONE
      COMPLEX*16 CI
      PARAMETER (CI=(0D0,1D0))
      COMPLEX*16 COUP1
      ...
      COMPLEX*16 TMP
      COMPLEX*16 VERTEX
      CALL FFVV16_0(F1,F2,V3,V4,COUP1,VERTEX)
      CALL FFVV9_0(F1,F2,V3,V4,COUP2,TMP)
      VERTEX = VERTEX + TMP
      END
