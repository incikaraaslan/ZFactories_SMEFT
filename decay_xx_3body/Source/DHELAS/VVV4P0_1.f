...
C     
     ...
     $ * W1))
      V1(3)= DENOM*(TMP5*(-CI*(P2(0))+CI*(P3(0)))+(V2(3)*(-CI*(TMP2)
     $ +CI*(TMP3))+V3(3)*(+CI*(TMP0)-CI*(TMP9))))
      V1(4)= DENOM*(TMP5*(-CI*(P2(1))+CI*(P3(1)))+(V2(4)*(-CI*(TMP2)
     $ +CI*(TMP3))+V3(4)*(+CI*(TMP0)-CI*(TMP9))))
      V1(5)= DENOM*(TMP5*(-CI*(P2(2))+CI*(P3(2)))+(V2(5)*(-CI*(TMP2)
     $ +CI*(TMP3))+V3(5)*(+CI*(TMP0)-CI*(TMP9))))
      V1(6)= DENOM*(TMP5*(-CI*(P2(3))+CI*(P3(3)))+(V2(6)*(-CI*(TMP2)
     $ +CI*(TMP3))+V3(6)*(+CI*(TMP0)-CI*(TMP9))))
      END
