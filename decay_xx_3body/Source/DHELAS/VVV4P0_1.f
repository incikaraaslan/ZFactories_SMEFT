...
C     
      SUBROUTINE VVV4P0_1(V2, V3, COUP, M1, W1,V1)
      IMPLICIT NONE
      COMPLEX*16 CI
     ...
     $ * W1))
      V1(3)= DENOM*(TMP23*(-CI*(P2(0))+CI*(P3(0)))+(V2(3)*(-CI*(TMP19)
     $ +CI*(TMP20))+V3(3)*(+CI*(TMP21)-CI*(TMP4))))
      V1(4)= DENOM*(TMP23*(-CI*(P2(1))+CI*(P3(1)))+(V2(4)*(-CI*(TMP19)
     $ +CI*(TMP20))+V3(4)*(+CI*(TMP21)-CI*(TMP4))))
      V1(5)= DENOM*(TMP23*(-CI*(P2(2))+CI*(P3(2)))+(V2(5)*(-CI*(TMP19)
     $ +CI*(TMP20))+V3(5)*(+CI*(TMP21)-CI*(TMP4))))
      V1(6)= DENOM*(TMP23*(-CI*(P2(3))+CI*(P3(3)))+(V2(6)*(-CI*(TMP19)
     $ +CI*(TMP20))+V3(6)*(+CI*(TMP21)-CI*(TMP4))))
      END
