...
C     
     ...
     $ * W3))
      V3(3)= DENOM*(-CI)*(F1(3)*F2(5)+F1(4)*F2(6)-P3(0)*TMP10*OM3)
      V3(4)= DENOM*(-CI)*(-F1(3)*F2(6)-F1(4)*F2(5)-P3(1)*TMP10*OM3)
      V3(5)= DENOM*(-CI)*(-CI*(F1(3)*F2(6))+CI*(F1(4)*F2(5))-P3(2)
     $ *TMP10*OM3)
      V3(6)= DENOM*(-CI)*(-F1(3)*F2(5)-P3(3)*TMP10*OM3+F1(4)*F2(6))
      END
