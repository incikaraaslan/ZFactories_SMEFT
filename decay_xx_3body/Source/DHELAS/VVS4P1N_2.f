...
C     
      ...
      V2(3)= COUP*S3(3)*(V1(3)*(+CI*(TMP26+TMP8))+(-CI*(P1(0)*TMP24
     $ +P3(0)*TMP5)))
      V2(4)= COUP*S3(3)*(V1(4)*(-1D0)*(+CI*(TMP26+TMP8))+(+CI*(P1(1)
     $ *TMP24+P3(1)*TMP5)))
      V2(5)= COUP*S3(3)*(V1(5)*(-1D0)*(+CI*(TMP26+TMP8))+(+CI*(P1(2)
     $ *TMP24+P3(2)*TMP5)))
      V2(6)= COUP*S3(3)*(V1(6)*(-1D0)*(+CI*(TMP26+TMP8))+(+CI*(P1(3)
     $ *TMP24+P3(3)*TMP5)))
      END
