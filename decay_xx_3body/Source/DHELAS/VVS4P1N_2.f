...
C     
      ...
      V2(3)= COUP*S3(3)*(V1(3)*(+CI*(TMP14+TMP11))+(-CI*(P1(0)*TMP13
     $ +TMP6*P3(0))))
      V2(4)= COUP*S3(3)*(V1(4)*(-1D0)*(+CI*(TMP14+TMP11))+(+CI*(P1(1)
     $ *TMP13+TMP6*P3(1))))
      V2(5)= COUP*S3(3)*(V1(5)*(-1D0)*(+CI*(TMP14+TMP11))+(+CI*(P1(2)
     $ *TMP13+TMP6*P3(2))))
      V2(6)= COUP*S3(3)*(V1(6)*(-1D0)*(+CI*(TMP14+TMP11))+(+CI*(P1(3)
     $ *TMP13+TMP6*P3(3))))
      END
