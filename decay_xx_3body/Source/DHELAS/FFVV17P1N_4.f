...
C     
      ...
      COMPLEX*16 V3(*)
      COMPLEX*16 V4(6)
      V4(3)= COUP*(-2D0 * CI)*(V3(4)*(-F1(3)*F2(4)-F1(4)*F2(3)+F1(6)
     $ *F2(5)+F1(5)*F2(6))+(V3(5)*(-CI*(F1(3)*F2(4)+F1(6)*F2(5))+CI
     $ *(F1(4)*F2(3)+F1(5)*F2(6)))+V3(6)*(-F1(3)*F2(3)-F1(6)*F2(6)
     $ +F1(4)*F2(4)+F1(5)*F2(5))))
      V4(4)= COUP*(-2D0 * CI)*(V3(3)*(F1(3)*F2(4)+F1(4)*F2(3)-F1(6)
     $ *F2(5)-F1(5)*F2(6))+(V3(5)*(+CI*(F1(3)*F2(3)+F1(5)*F2(5))-CI
     ...
     $ *F2(5))+V3(5)*(+CI*(F1(3)*F2(4)+F1(4)*F2(3)+F1(6)*F2(5)+F1(5)
     $ *F2(6)))))
      END
