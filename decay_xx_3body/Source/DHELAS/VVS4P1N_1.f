...
C     
      ...
      V1(3)= COUP*S3(3)*(V2(3)*(+CI*(TMP26+TMP8))+(-CI*(P3(0)*TMP21
     $ +P2(0)*TMP4)))
      V1(4)= COUP*S3(3)*(V2(4)*(-1D0)*(+CI*(TMP26+TMP8))+(+CI*(P3(1)
     $ *TMP21+P2(1)*TMP4)))
      V1(5)= COUP*S3(3)*(V2(5)*(-1D0)*(+CI*(TMP26+TMP8))+(+CI*(P3(2)
     $ *TMP21+P2(2)*TMP4)))
      V1(6)= COUP*S3(3)*(V2(6)*(-1D0)*(+CI*(TMP26+TMP8))+(+CI*(P3(3)
     $ *TMP21+P2(3)*TMP4)))
      END
