...
C     
      ...
      V1(3)= COUP*S3(3)*(V2(3)*(+CI*(TMP14+TMP11))+(-CI*(TMP0*P3(0)
     $ +P2(0)*TMP9)))
      V1(4)= COUP*S3(3)*(V2(4)*(-1D0)*(+CI*(TMP14+TMP11))+(+CI*(TMP0
     $ *P3(1)+P2(1)*TMP9)))
      V1(5)= COUP*S3(3)*(V2(5)*(-1D0)*(+CI*(TMP14+TMP11))+(+CI*(TMP0
     $ *P3(2)+P2(2)*TMP9)))
      V1(6)= COUP*S3(3)*(V2(6)*(-1D0)*(+CI*(TMP14+TMP11))+(+CI*(TMP0
     $ *P3(3)+P2(3)*TMP9)))
      END
