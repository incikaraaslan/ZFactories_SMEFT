...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL VVV4P0_1(W(1,4),W(1,3),GC_4,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(1,5),W(1,1),W(1,2),GC_246,AMP(1))
      CALL VVS1_3(W(1,4),W(1,3),GC_181,MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VVS3_0(W(1,1),W(1,2),W(1,5),GC_184,AMP(2))
