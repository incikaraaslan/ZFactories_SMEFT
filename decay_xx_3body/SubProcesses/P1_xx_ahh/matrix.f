...
C     COMMON/TO_HELICITY/  HEL_BUFF
      ...
      DATA (NHEL(I,   3),I=1,4) / 0,-1, 0, 0/
      DATA (NHEL(I,   4),I=1,4) / 0, 1, 0, 0/
      DATA (NHEL(I,   5),I=1,4) / 1,-1, 0, 0/
      DATA (NHEL(I,   6),I=1,4) / 1, 1, 0, 0/
      DATA IDEN/ 6/
C     ----------
C     BEGIN CODE
C     ----------
