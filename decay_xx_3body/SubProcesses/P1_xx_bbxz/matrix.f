...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL IXXXXX(P(0,3),MDL_MB,NHEL(3),-1*IC(3),W(1,3))
      CALL VXXXXX(P(0,4),MDL_MZ,NHEL(4),+1*IC(4),W(1,4))
      CALL FFS1_3(W(1,3),W(1,2),GC_249,MDL_MH, FK_MDL_WH,W(1,5))
...
C     Amplitude(s) for diagram number 4
      CALL FFVV1_16_19_5_8_9_0(W(1,3),W(1,2),W(1,1),W(1,4),GC_238
     $ ,GC_366,GC_130,GC_239,GC_134,GC_365,AMP(4))
