...
C     
C     Process: xx > ve ve~ z @1
C     Process: xx > vm vm~ z @1
C     Process: xx > vt vt~ z @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_3(W(1,3),W(1,2),GC_142,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL VVV3_0(W(1,1),W(1,5),W(1,4),GC_248,AMP(1))
C     Amplitude(s) for diagram number 2
      CALL FFVV8_0(W(1,3),W(1,2),W(1,1),W(1,4),GC_133,AMP(2))
