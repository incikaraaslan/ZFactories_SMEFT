...
C     COMMON/TO_HELICITY/  HEL_BUFF
      ...
      DATA (NHEL(I,   5),I=1,4) / 0,-1, 1, 0/
      DATA (NHEL(I,   6),I=1,4) / 0,-1,-1, 0/
      DATA (NHEL(I,   7),I=1,4) / 0, 1, 1, 0/
      DATA (NHEL(I,   8),I=1,4) / 0, 1,-1, 0/
      DATA (NHEL(I,   9),I=1,4) / 1,-1, 1, 0/
      DATA (NHEL(I,  10),I=1,4) / 1,-1,-1, 0/
      DATA (NHEL(I,  11),I=1,4) / 1, 1, 1, 0/
      DATA (NHEL(I,  12),I=1,4) / 1, 1,-1, 0/
      DATA IDEN/ 3/
C     ----------
C     BEGIN CODE
C     ----------
