...
C     
C     Process: xx > a ve ve~ @1
C     Process: xx > a vm vm~ @1
C     Process: xx > a vt vt~ @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_3(W(1,4),W(1,3),GC_142,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(1,2),W(1,1),W(1,5),GC_246,AMP(1))
C     Amplitude(s) for diagram number 2
      CALL FFVV7_0(W(1,4),W(1,3),W(1,2),W(1,1),GC_51,AMP(2))
