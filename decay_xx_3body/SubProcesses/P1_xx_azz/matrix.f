...
C     COMMON/TO_HELICITY/  HEL_BUFF
      ...
      DATA (NHEL(I,  19),I=1,4) / 0,-1,-1,-1/
      DATA (NHEL(I,  20),I=1,4) / 0,-1,-1, 0/
      DATA (NHEL(I,  21),I=1,4) / 0,-1,-1, 1/
      DATA (NHEL(I,  22),I=1,4) / 0,-1, 0,-1/
      DATA (NHEL(I,  23),I=1,4) / 0,-1, 0, 0/
      DATA (NHEL(I,  24),I=1,4) / 0,-1, 0, 1/
      DATA (NHEL(I,  25),I=1,4) / 0,-1, 1,-1/
      DATA (NHEL(I,  26),I=1,4) / 0,-1, 1, 0/
      DATA (NHEL(I,  27),I=1,4) / 0,-1, 1, 1/
      ...
      DATA (NHEL(I,  37),I=1,4) / 1,-1,-1,-1/
      DATA (NHEL(I,  38),I=1,4) / 1,-1,-1, 0/
      DATA (NHEL(I,  39),I=1,4) / 1,-1,-1, 1/
      DATA (NHEL(I,  40),I=1,4) / 1,-1, 0,-1/
      DATA (NHEL(I,  41),I=1,4) / 1,-1, 0, 0/
      DATA (NHEL(I,  42),I=1,4) / 1,-1, 0, 1/
      DATA (NHEL(I,  43),I=1,4) / 1,-1, 1,-1/
      DATA (NHEL(I,  44),I=1,4) / 1,-1, 1, 0/
      DATA (NHEL(I,  45),I=1,4) / 1,-1, 1, 1/
      DATA (NHEL(I,  46),I=1,4) / 1, 1,-1,-1/
      DATA (NHEL(I,  47),I=1,4) / 1, 1,-1, 0/
      DATA (NHEL(I,  48),I=1,4) / 1, 1,-1, 1/
      DATA (NHEL(I,  49),I=1,4) / 1, 1, 0,-1/
      DATA (NHEL(I,  50),I=1,4) / 1, 1, 0, 0/
      DATA (NHEL(I,  51),I=1,4) / 1, 1, 0, 1/
      DATA (NHEL(I,  52),I=1,4) / 1, 1, 1,-1/
      DATA (NHEL(I,  53),I=1,4) / 1, 1, 1, 0/
      DATA (NHEL(I,  54),I=1,4) / 1, 1, 1, 1/
      DATA IDEN/ 6/
C     ----------
C     BEGIN CODE
C     ----------
