...
C     COMMON/TO_HELICITY/  HEL_BUFF
      ...
      DATA (NHEL(I,   1),I=1,4) /-1,-1,-1, 0/
      DATA (NHEL(I,   2),I=1,4) /-1,-1, 0, 0/
      DATA (NHEL(I,   3),I=1,4) /-1,-1, 1, 0/
      DATA (NHEL(I,   4),I=1,4) /-1, 0,-1, 0/
      DATA (NHEL(I,   5),I=1,4) /-1, 0, 0, 0/
      DATA (NHEL(I,   6),I=1,4) /-1, 0, 1, 0/
      DATA (NHEL(I,   7),I=1,4) /-1, 1,-1, 0/
      DATA (NHEL(I,   8),I=1,4) /-1, 1, 0, 0/
      DATA (NHEL(I,   9),I=1,4) /-1, 1, 1, 0/
      DATA (NHEL(I,  10),I=1,4) / 0,-1,-1, 0/
      DATA (NHEL(I,  11),I=1,4) / 0,-1, 0, 0/
      DATA (NHEL(I,  12),I=1,4) / 0,-1, 1, 0/
      DATA (NHEL(I,  13),I=1,4) / 0, 0,-1, 0/
      DATA (NHEL(I,  14),I=1,4) / 0, 0, 0, 0/
      DATA (NHEL(I,  15),I=1,4) / 0, 0, 1, 0/
      DATA (NHEL(I,  16),I=1,4) / 0, 1,-1, 0/
      DATA (NHEL(I,  17),I=1,4) / 0, 1, 0, 0/
      DATA (NHEL(I,  18),I=1,4) / 0, 1, 1, 0/
      DATA (NHEL(I,  19),I=1,4) / 1,-1,-1, 0/
      DATA (NHEL(I,  20),I=1,4) / 1,-1, 0, 0/
      DATA (NHEL(I,  21),I=1,4) / 1,-1, 1, 0/
      DATA (NHEL(I,  22),I=1,4) / 1, 0,-1, 0/
      DATA (NHEL(I,  23),I=1,4) / 1, 0, 0, 0/
      DATA (NHEL(I,  24),I=1,4) / 1, 0, 1, 0/
      DATA (NHEL(I,  25),I=1,4) / 1, 1,-1, 0/
      DATA (NHEL(I,  26),I=1,4) / 1, 1, 0, 0/
      DATA (NHEL(I,  27),I=1,4) / 1, 1, 1, 0/
      DATA IDEN/ 6/
C     ----------
C     BEGIN CODE
C     ----------
...
C     Amplitude(s) for diagram number 1
      CALL VVS4_0(W(1,5),W(1,1),W(1,4),GC_180,AMP(1))
      CALL VVS3_1(W(1,2),W(1,4),GC_184,MDL_MX, FK_MDL_WX,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VVV2_0(W(1,5),W(1,1),W(1,3),GC_247,AMP(2))
      CALL VVS1_1(W(1,2),W(1,4),GC_243,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL VVV3_0(W(1,1),W(1,5),W(1,3),GC_248,AMP(3))
      CALL VVS3_1(W(1,3),W(1,4),GC_184,MDL_MX, FK_MDL_WX,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL VVV2_0(W(1,5),W(1,1),W(1,2),GC_247,AMP(4))
      CALL VVS1_1(W(1,3),W(1,4),GC_243,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 5
      CALL VVV3_0(W(1,1),W(1,2),W(1,5),GC_248,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL VVVS3_0(W(1,1),W(1,2),W(1,3),W(1,4),GC_244,AMP(6))
