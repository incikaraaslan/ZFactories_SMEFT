...
C     COMMON/TO_HELICITY/  HEL_BUFF
      ...
      DATA (NHEL(I,   4),I=1,4) /-1, 1,-1, 0/
      DATA (NHEL(I,   5),I=1,4) /-1, 1, 0, 0/
      DATA (NHEL(I,   6),I=1,4) /-1, 1, 1, 0/
      DATA (NHEL(I,   7),I=1,4) / 0,-1,-1, 0/
      DATA (NHEL(I,   8),I=1,4) / 0,-1, 0, 0/
      DATA (NHEL(I,   9),I=1,4) / 0,-1, 1, 0/
      DATA (NHEL(I,  10),I=1,4) / 0, 1,-1, 0/
      DATA (NHEL(I,  11),I=1,4) / 0, 1, 0, 0/
      DATA (NHEL(I,  12),I=1,4) / 0, 1, 1, 0/
      DATA (NHEL(I,  13),I=1,4) / 1,-1,-1, 0/
      DATA (NHEL(I,  14),I=1,4) / 1,-1, 0, 0/
      DATA (NHEL(I,  15),I=1,4) / 1,-1, 1, 0/
      DATA (NHEL(I,  16),I=1,4) / 1, 1,-1, 0/
      DATA (NHEL(I,  17),I=1,4) / 1, 1, 0, 0/
      DATA (NHEL(I,  18),I=1,4) / 1, 1, 1, 0/
      DATA IDEN/ 3/
C     ----------
C     BEGIN CODE
C     ----------
...
C     Amplitude(s) for diagram number 1
      ...
      CALL VVS2_2(W(1,2),W(1,4),GC_179,MDL_MX, FK_MDL_WX,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VVV2_0(W(1,5),W(1,1),W(1,3),GC_247,AMP(2))
      CALL VVS1_1(W(1,3),W(1,4),GC_243,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL VVV1_0(W(1,2),W(1,1),W(1,5),GC_246,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL VVVS1_0(W(1,2),W(1,1),W(1,3),W(1,4),GC_241,AMP(4))
