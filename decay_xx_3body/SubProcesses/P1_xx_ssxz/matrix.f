...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL IXXXXX(P(0,3),MDL_MS,NHEL(3),-1*IC(3),W(1,3))
      CALL VXXXXX(P(0,4),MDL_MZ,NHEL(4),+1*IC(4),W(1,4))
      CALL FFS1_3(W(1,3),W(1,2),GC_254,MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL VVS3_0(W(1,1),W(1,4),W(1,5),GC_184,AMP(1))
      CALL FFV1P0_3(W(1,3),W(1,2),GC_1,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VVV1_0(W(1,5),W(1,1),W(1,4),GC_246,AMP(2))
      CALL FFV2_3_3(W(1,3),W(1,2),GC_107,GC_126,MDL_MZ, FK_MDL_WZ,W(1
     $ ,5))
C     Amplitude(s) for diagram number 3
      CALL VVV3_0(W(1,1),W(1,5),W(1,4),GC_248,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFVV1_16_19_5_8_9_0(W(1,3),W(1,2),W(1,1),W(1,4),GC_223
     $ ,GC_269,GC_130,GC_224,GC_134,GC_268,AMP(4))
