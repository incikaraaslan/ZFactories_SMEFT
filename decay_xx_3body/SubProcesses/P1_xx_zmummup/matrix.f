...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL OXXXXX(P(0,3),MDL_MMU,NHEL(3),+1*IC(3),W(1,3))
      CALL IXXXXX(P(0,4),MDL_MMU,NHEL(4),-1*IC(4),W(1,4))
      CALL FFS1_3(W(1,4),W(1,3),GC_253,MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL VVS3_0(W(1,1),W(1,2),W(1,5),GC_184,AMP(1))
      CALL FFV1P0_3(W(1,4),W(1,3),GC_3,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VVV1_0(W(1,5),W(1,1),W(1,2),GC_246,AMP(2))
      CALL FFV2_4_3(W(1,4),W(1,3),GC_107,GC_127,MDL_MZ, FK_MDL_WZ,W(1
     $ ,5))
