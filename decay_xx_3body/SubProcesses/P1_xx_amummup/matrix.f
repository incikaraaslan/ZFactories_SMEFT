...
C     COMMON/TO_HELICITY/  HEL_BUFF
      ...
      DATA (NHEL(I,   9),I=1,4) / 0,-1,-1, 1/
      DATA (NHEL(I,  10),I=1,4) / 0,-1,-1,-1/
      DATA (NHEL(I,  11),I=1,4) / 0,-1, 1, 1/
      DATA (NHEL(I,  12),I=1,4) / 0,-1, 1,-1/
...
C     Amplitude(s) for diagram number 3
      CALL FFVV18_7_0(W(1,4),W(1,3),W(1,2),W(1,1),GC_40,GC_51,AMP(3))
