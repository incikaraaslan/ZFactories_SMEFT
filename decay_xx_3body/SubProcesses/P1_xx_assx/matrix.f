...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL OXXXXX(P(0,3),MDL_MS,NHEL(3),+1*IC(3),W(1,3))
      CALL IXXXXX(P(0,4),MDL_MS,NHEL(4),-1*IC(4),W(1,4))
      CALL FFS1_3(W(1,4),W(1,3),GC_254,MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL VVS2_0(W(1,2),W(1,1),W(1,5),GC_179,AMP(1))
      CALL FFV2_3_3(W(1,4),W(1,3),GC_107,GC_126,MDL_MZ, FK_MDL_WZ,W(1
     $ ,5))
C     Amplitude(s) for diagram number 2
      CALL VVV1_0(W(1,2),W(1,1),W(1,5),GC_246,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL FFVV18_7_0(W(1,4),W(1,3),W(1,2),W(1,1),GC_39,GC_52,AMP(3))
