...
C     COMMON/TO_HELICITY/  HEL_BUFF
      ...
      DATA (NHEL(I,   4),I=1,4) /-1, 0, 0, 1/
      DATA (NHEL(I,   5),I=1,4) /-1, 0, 0, 0/
      DATA (NHEL(I,   6),I=1,4) /-1, 0, 0,-1/
      DATA (NHEL(I,   7),I=1,4) /-1, 1, 0, 1/
      DATA (NHEL(I,   8),I=1,4) /-1, 1, 0, 0/
      DATA (NHEL(I,   9),I=1,4) /-1, 1, 0,-1/
      DATA (NHEL(I,  10),I=1,4) / 0,-1, 0, 1/
      DATA (NHEL(I,  11),I=1,4) / 0,-1, 0, 0/
      DATA (NHEL(I,  12),I=1,4) / 0,-1, 0,-1/
      DATA (NHEL(I,  13),I=1,4) / 0, 0, 0, 1/
      DATA (NHEL(I,  14),I=1,4) / 0, 0, 0, 0/
      DATA (NHEL(I,  15),I=1,4) / 0, 0, 0,-1/
      DATA (NHEL(I,  16),I=1,4) / 0, 1, 0, 1/
      DATA (NHEL(I,  17),I=1,4) / 0, 1, 0, 0/
      DATA (NHEL(I,  18),I=1,4) / 0, 1, 0,-1/
      DATA (NHEL(I,  19),I=1,4) / 1,-1, 0, 1/
      DATA (NHEL(I,  20),I=1,4) / 1,-1, 0, 0/
      DATA (NHEL(I,  21),I=1,4) / 1,-1, 0,-1/
      DATA (NHEL(I,  22),I=1,4) / 1, 0, 0, 1/
      DATA (NHEL(I,  23),I=1,4) / 1, 0, 0, 0/
      DATA (NHEL(I,  24),I=1,4) / 1, 0, 0,-1/
      DATA (NHEL(I,  25),I=1,4) / 1, 1, 0, 1/
      DATA (NHEL(I,  26),I=1,4) / 1, 1, 0, 0/
      DATA (NHEL(I,  27),I=1,4) / 1, 1, 0,-1/
      DATA IDEN/ 3/
C     ----------
C     BEGIN CODE
C     ----------
...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL VVV4P0_1(W(1,4),W(1,2),-GC_3,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL VVS2_0(W(1,5),W(1,1),W(1,3),GC_179,AMP(1))
      CALL VVV4_3(W(1,4),W(1,2),GC_109,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VVS3_0(W(1,1),W(1,5),W(1,3),GC_184,AMP(2))
