...
C     COMMON/TO_HELICITY/  HEL_BUFF
      ...
      DATA (NHEL(I,  15),I=1,4) / 0,-1, 0, 1/
      DATA (NHEL(I,  16),I=1,4) / 0,-1, 0,-1/
      DATA (NHEL(I,  17),I=1,4) / 0,-1,-1, 1/
      DATA (NHEL(I,  18),I=1,4) / 0,-1,-1,-1/
      DATA (NHEL(I,  19),I=1,4) / 0, 1, 1, 1/
      DATA (NHEL(I,  20),I=1,4) / 0, 1, 1,-1/
      DATA (NHEL(I,  21),I=1,4) / 0, 1, 0, 1/
      ...
      DATA (NHEL(I,  28),I=1,4) / 1,-1, 0,-1/
      DATA (NHEL(I,  29),I=1,4) / 1,-1,-1, 1/
      DATA (NHEL(I,  30),I=1,4) / 1,-1,-1,-1/
      DATA (NHEL(I,  31),I=1,4) / 1, 1, 1, 1/
      DATA (NHEL(I,  32),I=1,4) / 1, 1, 1,-1/
      DATA (NHEL(I,  33),I=1,4) / 1, 1, 0, 1/
      DATA (NHEL(I,  34),I=1,4) / 1, 1, 0,-1/
...
C     
      ...
      PARAMETER (NWAVEFUNCS=4, NCOLOR=1)
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
      COMPLEX*16 IMAG1
...
C     Amplitude(s) for diagram number 1
      CALL FFVV16_9_0(W(1,4),W(1,2),W(1,3),W(1,1),GC_195,GC_193,AMP(1))
