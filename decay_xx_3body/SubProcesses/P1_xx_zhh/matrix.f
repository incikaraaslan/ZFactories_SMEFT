...
C     COMMON/TO_HELICITY/  HEL_BUFF
      ...
      DATA (NHEL(I,   2),I=1,4) /-1, 0, 0, 0/
      DATA (NHEL(I,   3),I=1,4) /-1, 1, 0, 0/
      DATA (NHEL(I,   4),I=1,4) / 0,-1, 0, 0/
      DATA (NHEL(I,   5),I=1,4) / 0, 0, 0, 0/
      DATA (NHEL(I,   6),I=1,4) / 0, 1, 0, 0/
      DATA (NHEL(I,   7),I=1,4) / 1,-1, 0, 0/
      DATA (NHEL(I,   8),I=1,4) / 1, 0, 0, 0/
      DATA (NHEL(I,   9),I=1,4) / 1, 1, 0, 0/
      DATA IDEN/ 6/
C     ----------
C     BEGIN CODE
C     ----------
...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL VVS3_1(W(1,2),W(1,3),GC_184,MDL_MX, FK_MDL_WX,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL VVS4_0(W(1,5),W(1,1),W(1,4),GC_180,AMP(1))
      CALL VVS1_1(W(1,2),W(1,3),GC_243,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VVS3_0(W(1,1),W(1,5),W(1,4),GC_184,AMP(2))
      CALL VVS3_1(W(1,2),W(1,4),GC_184,MDL_MX, FK_MDL_WX,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL VVS4_0(W(1,5),W(1,1),W(1,3),GC_180,AMP(3))
      CALL VVS1_1(W(1,2),W(1,4),GC_243,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL VVS3_0(W(1,1),W(1,5),W(1,3),GC_184,AMP(4))
      CALL SSS1_1(W(1,3),W(1,4),GC_178,MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 5
      CALL VVS3_0(W(1,1),W(1,2),W(1,5),GC_184,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL VVSS3_0(W(1,1),W(1,2),W(1,3),W(1,4),GC_132,AMP(6))
