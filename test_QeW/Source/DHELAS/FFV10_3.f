...
C     
     ...
     $ *P3(3)))
      TMP25 = (F1(3)*-F2(3)*(-P3(0)*P3(0)+P3(1)*P3(1)+P3(2)*P3(2)+P3(3)
     ...
     $ *P3(2)+P3(3)*P3(3)))))
      TMP26 = (F1(5)*-F2(5)*(-P3(0)*P3(0)+P3(1)*P3(1)+P3(2)*P3(2)+P3(3)
     ...
     $ -F2(4)*F1(4)-F2(5)*F1(5))+1D0/2D0*(OM3*P3(0)*(-TMP25+TMP11
     $ +TMP26)))))
     ...
     $ +F2(4)*F1(3)+F2(6)*F1(5))+1D0/2D0*(OM3*P3(1)*(-TMP25+TMP11
     $ +TMP26)))))
     ...
     $ -1D0/2D0*(OM3*P3(2)*(-CI*(TMP25)+CI*(TMP11+TMP26))))))
     ...
     $ +F2(6)*F1(5)))-1D0/2D0*(OM3*P3(3)*(-TMP25+TMP11+TMP26)))))
      END
