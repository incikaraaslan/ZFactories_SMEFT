...
C     
      ...
      P3(2) = -DIMAG(V3(2))
      P3(3) = -DIMAG(V3(1))
      V3(3)= COUP*(-2D0 * CI)*(P3(1)*(F2(3)*F1(4)+F2(4)*F1(3)-F2(5)
     $ *F1(6)-F2(6)*F1(5))+(P3(2)*(-CI*(F2(3)*F1(4)+F2(6)*F1(5))+CI
     $ *(F2(4)*F1(3)+F2(5)*F1(6)))+P3(3)*(F2(3)*F1(3)+F2(6)*F1(6)-F2(4)
     $ *F1(4)-F2(5)*F1(5))))
      V3(4)= COUP*2D0 * CI*(P3(0)*(F2(3)*F1(4)+F2(4)*F1(3)-F2(5)*F1(6)
     $ -F2(6)*F1(5))+(P3(2)*(+CI*(F2(3)*F1(3)+F2(5)*F1(5))-CI*(F2(4)
     $ *F1(4)+F2(6)*F1(6)))+P3(3)*(-F2(3)*F1(4)-F2(5)*F1(6)+F2(4)*F1(3)
     $ +F2(6)*F1(5))))
      V3(5)= COUP*(-2D0)*(P3(0)*(-F2(3)*F1(4)-F2(6)*F1(5)+F2(4)*F1(3)
