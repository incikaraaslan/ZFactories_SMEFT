...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV1P0_3(W(1,2),W(1,1),GC_1,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(1,3),W(1,5),W(1,6),-GC_3,AMP(1))
      CALL FFV2_3_3(W(1,2),W(1,1),GC_50,GC_58,MDL_MZ, FK_MDL_WZ,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL VVV1_0(W(1,5),W(1,6),W(1,3),GC_53,AMP(2))
      CALL FFV2_2(W(1,2),W(1,5),GC_100,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,3),W(1,1),W(1,6),GC_100,AMP(3))
