...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL IXXXXX(P(0,5),MDL_MM,NHEL(5),-1*IC(5),W(1,4))
      CALL OXXXXX(P(0,6),ZERO,NHEL(6),+1*IC(6),W(1,3))
      CALL FFV2_3(W(1,4),W(1,3),GC_100,MDL_MW, FK_MDL_WW,W(1,6))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_2,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(1,3),W(1,5),W(1,6),-GC_3,AMP(1))
      CALL FFV2_5_3(W(1,1),W(1,2),-GC_50,GC_58,MDL_MZ, FK_MDL_WZ,W(1,3)
     $ )
C     Amplitude(s) for diagram number 2
      CALL VVV1_0(W(1,5),W(1,6),W(1,3),GC_53,AMP(2))
      CALL FFV2_2(W(1,1),W(1,6),GC_100,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,3),W(1,2),W(1,5),GC_100,AMP(3))
