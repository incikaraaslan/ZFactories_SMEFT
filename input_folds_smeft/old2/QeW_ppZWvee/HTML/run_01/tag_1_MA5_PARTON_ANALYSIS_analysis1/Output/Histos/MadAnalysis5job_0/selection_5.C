void selection_5()
{
  ...
  S6_PT_0->SetBinContent(1,2.218952323527309);
  S6_PT_0->SetBinContent(2,1.2652404496122245);
  S6_PT_0->SetBinContent(3,0.1813265737521287);
  S6_PT_0->SetBinContent(4,0.008091653108337598);
