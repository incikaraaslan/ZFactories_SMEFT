void selection_2()
{
  ...
  S3_SQRTS_0->SetBinContent(7,0.01728671063946462);
  S3_SQRTS_0->SetBinContent(8,1.1817493326261048);
  S3_SQRTS_0->SetBinContent(9,0.6679292601865695);
  S3_SQRTS_0->SetBinContent(10,1.263769316178383);
  S3_SQRTS_0->SetBinContent(11,0.5428763803694782);
  ...
  S3_SQRTS_0->SetBinContent(34,0.0);
