...
C     
C     Process: z w- > e- ve~ NPcHe=0 NPcHl1=0 NPcHl3=0 NPceB=0 NPceH=0
C      NPceW<=1 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
...
C     COMMON/TO_HELICITY/  HEL_BUFF
      ...
      DATA (NHEL(I,   5),I=1,4) /-1, 0,-1, 1/
      DATA (NHEL(I,   6),I=1,4) /-1, 0,-1,-1/
      DATA (NHEL(I,   7),I=1,4) /-1, 0, 1, 1/
      DATA (NHEL(I,   8),I=1,4) /-1, 0, 1,-1/
      DATA (NHEL(I,   9),I=1,4) /-1, 1,-1, 1/
      DATA (NHEL(I,  10),I=1,4) /-1, 1,-1,-1/
      DATA (NHEL(I,  11),I=1,4) /-1, 1, 1, 1/
      DATA (NHEL(I,  12),I=1,4) /-1, 1, 1,-1/
      DATA (NHEL(I,  13),I=1,4) / 0,-1,-1, 1/
      DATA (NHEL(I,  14),I=1,4) / 0,-1,-1,-1/
      DATA (NHEL(I,  15),I=1,4) / 0,-1, 1, 1/
      DATA (NHEL(I,  16),I=1,4) / 0,-1, 1,-1/
      DATA (NHEL(I,  17),I=1,4) / 0, 0,-1, 1/
      DATA (NHEL(I,  18),I=1,4) / 0, 0,-1,-1/
      DATA (NHEL(I,  19),I=1,4) / 0, 0, 1, 1/
      DATA (NHEL(I,  20),I=1,4) / 0, 0, 1,-1/
      DATA (NHEL(I,  21),I=1,4) / 0, 1,-1, 1/
      DATA (NHEL(I,  22),I=1,4) / 0, 1,-1,-1/
      DATA (NHEL(I,  23),I=1,4) / 0, 1, 1, 1/
      DATA (NHEL(I,  24),I=1,4) / 0, 1, 1,-1/
      DATA (NHEL(I,  25),I=1,4) / 1,-1,-1, 1/
      DATA (NHEL(I,  26),I=1,4) / 1,-1,-1,-1/
      DATA (NHEL(I,  27),I=1,4) / 1,-1, 1, 1/
      DATA (NHEL(I,  28),I=1,4) / 1,-1, 1,-1/
      DATA (NHEL(I,  29),I=1,4) / 1, 0,-1, 1/
      DATA (NHEL(I,  30),I=1,4) / 1, 0,-1,-1/
      DATA (NHEL(I,  31),I=1,4) / 1, 0, 1, 1/
      DATA (NHEL(I,  32),I=1,4) / 1, 0, 1,-1/
      DATA (NHEL(I,  33),I=1,4) / 1, 1,-1, 1/
      DATA (NHEL(I,  34),I=1,4) / 1, 1,-1,-1/
      DATA (NHEL(I,  35),I=1,4) / 1, 1, 1, 1/
...
C     Amplitude(s) for diagram number 1
      CALL FFVV2_0(W(1,4),W(1,3),W(1,2),W(1,1),GC_6942,AMP(1))
      CALL VVV5_1(W(1,2),W(1,1),GC_5911,MDL_MW, FK_MDL_WW,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV3_0(W(1,4),W(1,3),W(1,5),GC_5899,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL FFV4_0(W(1,4),W(1,3),W(1,5),GC_6464,AMP(3))
      CALL FFV1_3_1(W(1,3),W(1,1),GC_6187,-GC_5909,ZERO, FK_ZERO,W(1,5)
     $ )
C     Amplitude(s) for diagram number 4
      CALL FFV3_0(W(1,4),W(1,5),W(1,2),GC_5899,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV4_0(W(1,4),W(1,5),W(1,2),GC_6464,AMP(5))
      CALL FFV10_1(W(1,3),W(1,1),GC_6527,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 6
      CALL FFV3_0(W(1,4),W(1,5),W(1,2),GC_5899,AMP(6))
      CALL FFV3_2(W(1,4),W(1,1),GC_5909,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 7
      CALL FFV3_0(W(1,5),W(1,3),W(1,2),GC_5899,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV4_0(W(1,5),W(1,3),W(1,2),GC_6464,AMP(8))
