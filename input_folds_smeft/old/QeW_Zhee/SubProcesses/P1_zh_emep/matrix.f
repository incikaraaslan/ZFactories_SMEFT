...
C     
C     Process: z h > e- e+ NPcHe=0 NPcHl1=0 NPcHl3=0 NPceB=0 NPceH=0
C      NPceW<=1 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
...
C     Amplitude(s) for diagram number 1
      CALL FFVS6_0(W(1,4),W(1,3),W(1,1),W(1,2),GC_5263,AMP(1))
      CALL VVS4P0_1(W(1,1),W(1,2),GC_6361,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),-GC_3,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL FFV10_0(W(1,4),W(1,3),W(1,5),GC_7028,AMP(3))
      CALL VVS3_1(W(1,1),W(1,2),GC_6738,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV1_3_0(W(1,4),W(1,3),W(1,5),GC_6187,-GC_5909,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV10_0(W(1,4),W(1,3),W(1,5),GC_6527,AMP(5))
