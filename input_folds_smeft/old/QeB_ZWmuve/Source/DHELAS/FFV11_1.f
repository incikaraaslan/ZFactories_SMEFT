...
C     
      SUBROUTINE FFV11_1(F2, V3, COUP, M1, W1,F1)
      IMPLICIT NONE
      COMPLEX*16 CI
     ...
     $ *P3(0))-V3(5)*P3(1)+V3(4)*P3(2)-CI*(V3(3)*P3(3)))))))
     ...
     $ +CI*(V3(4)*P3(2))+V3(3)*P3(3))))))
      F1(5)= DENOM*(-2D0 )* CI * M1*(F2(6)*(P3(0)*(-1D0)*(V3(4)+CI
     $ *(V3(5)))+(P3(1)*(V3(3)-V3(6))+(P3(2)*(+CI*(V3(3))-CI*(V3(6)))
     $ +P3(3)*(V3(4)+CI*(V3(5))))))+F2(5)*(-V3(6)*P3(0)-CI*(V3(5)*P3(1)
     $ )+CI*(V3(4)*P3(2))+V3(3)*P3(3)))
      F1(6)= DENOM*(-2D0 )* CI * M1*(F2(5)*(P3(0)*(-V3(4)+CI*(V3(5)))
     $ +(P3(1)*(V3(3)+V3(6))+(P3(2)*(-1D0)*(+CI*(V3(3)+V3(6)))+P3(3)*(
...
C      P(-1,3)*Gamma(-1,-3,-2)*Gamma(3,2,-3)*ProjP(-2,1)
C     
      SUBROUTINE FFV11_4_1(F2, V3, COUP1, COUP2, M1, W1,F1)
      IMPLICIT NONE
      COMPLEX*16 CI
      PARAMETER (CI=(0D0,1D0))
      COMPLEX*16 COUP1
      ...
      COMPLEX*16 DENOM
      INTEGER*4 I
      CALL FFV11_1(F2,V3,COUP1,M1,W1,F1)
