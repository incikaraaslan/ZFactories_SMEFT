void selection_4()
{
  ...
  S5_ETA_0->SetBinContent(14,0.061300193261000176);
  S5_ETA_0->SetBinContent(15,0.0);
  S5_ETA_0->SetBinContent(16,0.6130019326100018);
  S5_ETA_0->SetBinContent(17,3.6780111956599897);
  S5_ETA_0->SetBinContent(18,18.819161001127146);
  S5_ETA_0->SetBinContent(19,85.14596452952905);
  S5_ETA_0->SetBinContent(20,202.84231079064807);
  S5_ETA_0->SetBinContent(21,194.0151103210655);
  S5_ETA_0->SetBinContent(22,84.04256447083122);
  S5_ETA_0->SetBinContent(23,19.186961020693083);
  S5_ETA_0->SetBinContent(24,4.1684132217480165);
  S5_ETA_0->SetBinContent(25,0.4291013228269997);
  ...
  stack->GetXaxis()->SetTitle("#eta [ b~_{1} ] ");
