void selection_5()
{
  ...
  S6_PT_0->SetBinContent(2,0.0);
  S6_PT_0->SetBinContent(3,0.0);
  S6_PT_0->SetBinContent(4,0.0);
  ...
  S6_PT_0->SetBinContent(30,0.061300189980999994);
  ...
  S6_PT_0->SetBinContent(41,612.940599810019); // overflow
