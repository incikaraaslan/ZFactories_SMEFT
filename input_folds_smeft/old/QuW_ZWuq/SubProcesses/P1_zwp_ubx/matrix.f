...
C     
C     Process: z w+ > u b~ WEIGHTED<=104 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL FFVV2_0(W(1,4),W(1,3),W(1,2),W(1,1),GC_7557,AMP(1))
      CALL VVV5_2(W(1,2),W(1,1),GC_5911,MDL_MW, FK_MDL_WW,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV4_0(W(1,4),W(1,3),W(1,5),GC_7444,AMP(2))
      CALL FFV1_3_1(W(1,3),W(1,1),GC_6186,GC_5909,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV4_0(W(1,4),W(1,5),W(1,2),GC_7444,AMP(3))
      CALL FFV11_4_1(W(1,3),W(1,1),GC_6637,GC_6641,MDL_MT, ZERO,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV3_0(W(1,4),W(1,5),W(1,2),GC_5899,AMP(4))
      CALL FFV1_3_2(W(1,4),W(1,1),GC_6185,-GC_5909,MDL_MB, FK_ZERO,W(1
     $ ,5))
C     Amplitude(s) for diagram number 5
      CALL FFV4_0(W(1,5),W(1,3),W(1,2),GC_7444,AMP(5))
