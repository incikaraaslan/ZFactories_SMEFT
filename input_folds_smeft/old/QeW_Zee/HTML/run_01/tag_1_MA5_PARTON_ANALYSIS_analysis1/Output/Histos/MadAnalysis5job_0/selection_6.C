void selection_6()
{
  ...
  S7_ETA_0->SetBinContent(11,0.16812398320000166);
  S7_ETA_0->SetBinContent(12,0.08406199160000083);
  S7_ETA_0->SetBinContent(13,0.42030995800000415);
  S7_ETA_0->SetBinContent(14,1.6812398320000166);
  S7_ETA_0->SetBinContent(15,3.446541655600034);
  S7_ETA_0->SetBinContent(16,8.910571109600088);
  S7_ETA_0->SetBinContent(17,23.53735764800023);
  S7_ETA_0->SetBinContent(18,60.8608839184004);
  S7_ETA_0->SetBinContent(19,128.69888713960347);
  S7_ETA_0->SetBinContent(20,191.1569808984007);
  S7_ETA_0->SetBinContent(21,193.42668067159812);
  S7_ETA_0->SetBinContent(22,123.99148760999623);
  S7_ETA_0->SetBinContent(23,64.22336358240044);
  S7_ETA_0->SetBinContent(24,24.798287522000244);
  S7_ETA_0->SetBinContent(25,10.0033790003999);
  S7_ETA_0->SetBinContent(26,2.8581077144000284);
  S7_ETA_0->SetBinContent(27,1.5131158488000147);
  S7_ETA_0->SetBinContent(28,0.504371949600005);
  S7_ETA_0->SetBinContent(29,0.16812398320000166);
  S7_ETA_0->SetBinContent(30,0.08406199160000083);
  S7_ETA_0->SetBinContent(31,0.08406199160000083);
