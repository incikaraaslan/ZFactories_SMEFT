void selection_6()
{
  ...
  S7_ETA_0->SetBinContent(15,0.0011324998800000127);
  S7_ETA_0->SetBinContent(16,0.003397499640000038);
  S7_ETA_0->SetBinContent(17,0.033408746460000374);
  S7_ETA_0->SetBinContent(18,0.1885612800199968);
  S7_ETA_0->SetBinContent(19,0.801809915040009);
  S7_ETA_0->SetBinContent(20,1.8493728040399677);
  S7_ETA_0->SetBinContent(21,1.7961448096800203);
  S7_ETA_0->SetBinContent(22,0.7853887167800035);
  S7_ETA_0->SetBinContent(23,0.1698749820000019);
  S7_ETA_0->SetBinContent(24,0.028878746940000324);
  S7_ETA_0->SetBinContent(25,0.0039637495800000444);
  S7_ETA_0->SetBinContent(26,0.0005662499400000063);
  ...
  stack->GetXaxis()->SetTitle("#eta [ u~_{1} ] ");
