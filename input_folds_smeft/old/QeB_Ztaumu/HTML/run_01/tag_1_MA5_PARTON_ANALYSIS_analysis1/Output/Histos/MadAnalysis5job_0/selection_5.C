void selection_5()
{
  ...
  S6_PT_0->SetBinContent(1,9.857991689700047e-06);
  S6_PT_0->SetBinContent(2,3.5032532451000167e-05);
  S6_PT_0->SetBinContent(3,7.24005650654002e-05);
  S6_PT_0->SetBinContent(4,0.00015427891079389954);
