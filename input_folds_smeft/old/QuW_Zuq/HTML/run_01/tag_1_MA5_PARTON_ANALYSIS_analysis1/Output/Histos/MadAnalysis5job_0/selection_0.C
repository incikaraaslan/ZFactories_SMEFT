void selection_0()
{
  ...
  S1_THT_0->SetBinContent(1,24.97442257999966);
  S1_THT_0->SetBinContent(2,89.15288920999969);
  S1_THT_0->SetBinContent(3,136.4881140999972);
  S1_THT_0->SetBinContent(4,218.38102255999965);
  S1_THT_0->SetBinContent(5,321.47313321000007);
  S1_THT_0->SetBinContent(6,461.1556476399969);
  S1_THT_0->SetBinContent(7,822.7040849900035);
  S1_THT_0->SetBinContent(8,829.6736857100028);
