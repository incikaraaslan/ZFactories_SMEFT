void selection_3()
{
  ...
  S4_PT_0->SetBinContent(1,114.12729607000075);
  S4_PT_0->SetBinContent(2,354.8690877800027);
  S4_PT_0->SetBinContent(3,782.6286730500046);
  S4_PT_0->SetBinContent(4,1652.3779430999916);
  ...
  stack->GetXaxis()->SetTitle("p_{T} [ u_{1} ] (GeV/c) ");
