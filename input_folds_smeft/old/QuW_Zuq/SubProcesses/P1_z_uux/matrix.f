...
C     Amplitude(s) for diagram number 1
      CALL FFV1_3_0(W(1,3),W(1,2),W(1,1),GC_6186,GC_5909,AMP(1))
C     Amplitude(s) for diagram number 2
      CALL FFV10_0(W(1,3),W(1,2),W(1,1),GC_6635,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL FFV3_0(W(1,3),W(1,2),W(1,1),-GC_7674,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,3),W(1,2),W(1,1),GC_7694,AMP(4))
