...
C     
C     Process: z h > mu- ta+ NPcHe=0 NPcHl1=0 NPcHl3=0 NPceB=0 NPceH=0
C      NPceW<=1 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
...
C     COMMON/TO_HELICITY/  HEL_BUFF
      ...
      DATA (NHEL(I,   1),I=1,4) /-1, 0,-1, 1/
      DATA (NHEL(I,   2),I=1,4) /-1, 0,-1,-1/
      DATA (NHEL(I,   3),I=1,4) /-1, 0, 1, 1/
      DATA (NHEL(I,   4),I=1,4) /-1, 0, 1,-1/
      DATA (NHEL(I,   5),I=1,4) / 0, 0,-1, 1/
      DATA (NHEL(I,   6),I=1,4) / 0, 0,-1,-1/
      DATA (NHEL(I,   7),I=1,4) / 0, 0, 1, 1/
      DATA (NHEL(I,   8),I=1,4) / 0, 0, 1,-1/
      DATA (NHEL(I,   9),I=1,4) / 1, 0,-1, 1/
      DATA (NHEL(I,  10),I=1,4) / 1, 0,-1,-1/
      DATA (NHEL(I,  11),I=1,4) / 1, 0, 1, 1/
...
C     Amplitude(s) for diagram number 1
      CALL FFVS3_7_0(W(1,4),W(1,3),W(1,1),W(1,2),GC_5270,GC_5268,AMP(1)
     $ )
      CALL VVS4P0_1(W(1,1),W(1,2),GC_6361,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV11_4_0(W(1,4),W(1,3),W(1,5),GC_7033,GC_7035,AMP(2))
      CALL VVS3_1(W(1,1),W(1,2),GC_6738,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV11_4_0(W(1,4),W(1,3),W(1,5),GC_6532,GC_6534,AMP(3))
      CALL FFV11_4_1(W(1,3),W(1,1),GC_6532,GC_6534,MDL_MTA, FK_ZERO
     $ ,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFS2_0(W(1,4),W(1,5),W(1,2),GC_7743,AMP(4))
