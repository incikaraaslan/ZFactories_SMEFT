void selection_6()
{
  ...
  S7_ETA_0->SetBinContent(16,0.21258047944000003);
  S7_ETA_0->SetBinContent(17,1.6740708380900426);
  S7_ETA_0->SetBinContent(18,8.131203213580013);
  S7_ETA_0->SetBinContent(19,36.45755647395959);
  S7_ETA_0->SetBinContent(20,85.88251169376021);
  S7_ETA_0->SetBinContent(21,85.59021172203039);
  S7_ETA_0->SetBinContent(22,38.23791630176976);
  S7_ETA_0->SetBinContent(23,7.785760246989983);
  S7_ETA_0->SetBinContent(24,1.4614908586499942);
  S7_ETA_0->SetBinContent(25,0.29229817172999883);
