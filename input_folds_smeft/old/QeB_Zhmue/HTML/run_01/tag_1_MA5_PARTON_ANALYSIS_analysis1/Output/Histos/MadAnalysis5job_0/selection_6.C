void selection_6()
{
  ...
  S7_ETA_0->SetBinContent(16,0.06300879017599999);
  S7_ETA_0->SetBinContent(17,0.4804420013419999);
  S7_ETA_0->SetBinContent(18,2.3392010065339988);
  S7_ETA_0->SetBinContent(19,11.018660030777994);
  S7_ETA_0->SetBinContent(20,25.557940071389993);
  S7_ETA_0->SetBinContent(21,25.093250070091997);
  S7_ETA_0->SetBinContent(22,11.215570031328014);
  S7_ETA_0->SetBinContent(23,2.433715006798001);
  S7_ETA_0->SetBinContent(24,0.48831810136399983);
  S7_ETA_0->SetBinContent(25,0.070884890198);
