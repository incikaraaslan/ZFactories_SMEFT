...
C     
C     Process: z h > mu- e+ NPcHe=0 NPcHl1=0 NPcHl3=0 NPceB<=1 NPceH=0
C      NPceW=0 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
...
C     Amplitude(s) for diagram number 1
      CALL FFVS3_7_0(W(1,4),W(1,3),W(1,1),W(1,2),GC_6204,GC_6206,AMP(1)
     $ )
      CALL VVS4P0_1(W(1,1),W(1,2),GC_6361,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV11_4_0(W(1,4),W(1,3),W(1,5),GC_6506,GC_6504,AMP(2))
      CALL VVS3_1(W(1,1),W(1,2),GC_6738,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV11_4_0(W(1,4),W(1,3),W(1,5),GC_7007,GC_7005,AMP(3))
