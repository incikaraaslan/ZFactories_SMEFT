void selection_5()
{
  ...
  S6_PT_0->SetBinContent(1,1.0182751125000124e-05);
  S6_PT_0->SetBinContent(2,3.494720386100065e-05);
  S6_PT_0->SetBinContent(3,7.176802792900065e-05);
  S6_PT_0->SetBinContent(4,0.00015464201708499856);
  S6_PT_0->SetBinContent(5,0.0);
  S6_PT_0->SetBinContent(6,0.0);
  S6_PT_0->SetBinContent(7,0.0);
  S6_PT_0->SetBinContent(8,0.0);
  S6_PT_0->SetBinContent(9,0.0);
  S6_PT_0->SetBinContent(10,0.0);
  S6_PT_0->SetBinContent(11,0.0);
  S6_PT_0->SetBinContent(12,0.0);
