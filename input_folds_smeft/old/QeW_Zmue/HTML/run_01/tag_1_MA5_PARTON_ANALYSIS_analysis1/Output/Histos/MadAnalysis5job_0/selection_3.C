void selection_3()
{
  ...
  S4_PT_0->SetBinContent(1,3.550837112499987e-05);
  S4_PT_0->SetBinContent(2,0.00012186470386099877);
  S4_PT_0->SetBinContent(3,0.0002502630079289994);
  S4_PT_0->SetBinContent(4,0.000539253917085002);
  ...
  stack->GetXaxis()->SetTitle("p_{T} [ e+_{1} ] (GeV/c) ");
