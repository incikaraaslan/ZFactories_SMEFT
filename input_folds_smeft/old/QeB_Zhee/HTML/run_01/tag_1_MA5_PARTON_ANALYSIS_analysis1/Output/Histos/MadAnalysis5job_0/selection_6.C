void selection_6()
{
  ...
  S7_ETA_0->SetBinContent(16,0.11087550481000227);
  S7_ETA_0->SetBinContent(17,0.8955325388500016);
  S7_ETA_0->SetBinContent(18,2.8145311221000178);
  S7_ETA_0->SetBinContent(19,11.53105050024015);
  S7_ETA_0->SetBinContent(20,27.01949117215984);
  S7_ETA_0->SetBinContent(21,26.951261169199885);
  S7_ETA_0->SetBinContent(22,11.906320516520116);
  S7_ETA_0->SetBinContent(23,3.078926133570005);
  S7_ETA_0->SetBinContent(24,0.801714834780001);
  S7_ETA_0->SetBinContent(25,0.17910650777000034);
