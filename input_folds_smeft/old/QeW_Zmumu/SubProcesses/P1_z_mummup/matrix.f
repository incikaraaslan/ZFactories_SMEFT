...
C     
C     Process: z > mu- mu+ NPcHe=0 NPcHl1=0 NPcHl3=0 NPceB=0 NPceH=0
C      NPceW<=1 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
...
C     Amplitude(s) for diagram number 1
      CALL FFV1_3_0(W(1,3),W(1,2),W(1,1),GC_6187,-GC_5909,AMP(1))
C     Amplitude(s) for diagram number 2
      CALL FFV10_0(W(1,3),W(1,2),W(1,1),GC_6531,AMP(2))
