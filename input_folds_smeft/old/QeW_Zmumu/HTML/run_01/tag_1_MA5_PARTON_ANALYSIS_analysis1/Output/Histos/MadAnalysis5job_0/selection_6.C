void selection_6()
{
  ...
  S7_ETA_0->SetBinContent(11,0.16812408966199816);
  S7_ETA_0->SetBinContent(12,0.08406202483100031);
  S7_ETA_0->SetBinContent(13,0.4203101741549985);
  S7_ETA_0->SetBinContent(14,1.6812408966199814);
  S7_ETA_0->SetBinContent(15,3.446542788071027);
  S7_ETA_0->SetBinContent(16,8.910574452086044);
  S7_ETA_0->SetBinContent(17,23.537368552679986);
  S7_ETA_0->SetBinContent(18,60.8609062576442);
  S7_ETA_0->SetBinContent(19,128.69899208625952);
  S7_ETA_0->SetBinContent(20,191.15708824569202);
  S7_ETA_0->SetBinContent(21,193.42668810613364);
  S7_ETA_0->SetBinContent(22,123.9914923757251);
  S7_ETA_0->SetBinContent(23,64.22338605088429);
  S7_ETA_0->SetBinContent(24,24.79829847514502);
  S7_ETA_0->SetBinContent(25,10.003379384889133);
  S7_ETA_0->SetBinContent(26,2.8581088242540114);
  S7_ETA_0->SetBinContent(27,1.5131169069579773);
  S7_ETA_0->SetBinContent(28,0.5043721689860007);
  S7_ETA_0->SetBinContent(29,0.16812408966199816);
  S7_ETA_0->SetBinContent(30,0.08406202483100031);
  S7_ETA_0->SetBinContent(31,0.08406202483100031);
