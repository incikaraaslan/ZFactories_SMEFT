...
MAbool user::Execute(SampleFormat& sample, const EventFormat& event)
{
  ...
  {
  {
    ...
    {
    MAuint32 b[1];
    for (b[0]=0;b[0]<_P_e_m_I1I_PTorderingfinalstate_REG_.size();b[0]++)
    {
      Manager()->FillHisto("9_DELTAR", _P_e_p_I1I_PTorderingfinalstate_REG_[a[0]]->dr(_P_e_m_I1I_PTorderingfinalstate_REG_[b[0]]));
    }
    }
  }
  }
