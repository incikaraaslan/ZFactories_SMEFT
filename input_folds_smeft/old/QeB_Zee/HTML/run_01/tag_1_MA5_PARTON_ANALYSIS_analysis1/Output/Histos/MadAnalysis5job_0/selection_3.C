void selection_3()
{
  ...
  S4_PT_0->SetBinContent(1,31.60730962400002);
  S4_PT_0->SetBinContent(2,106.59059873200019);
  S4_PT_0->SetBinContent(3,223.1845973450001);
  S4_PT_0->SetBinContent(4,479.23749429899954);
