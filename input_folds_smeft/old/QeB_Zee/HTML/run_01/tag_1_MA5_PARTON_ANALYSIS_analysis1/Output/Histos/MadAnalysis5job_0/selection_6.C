void selection_6()
{
  ...
  S7_ETA_0->SetBinContent(10,0.08406199160000082);
  S7_ETA_0->SetBinContent(11,0.08406199160000082);
  S7_ETA_0->SetBinContent(12,0.16812398320000163);
  S7_ETA_0->SetBinContent(13,0.504371949600005);
  S7_ETA_0->SetBinContent(14,1.5131158488000147);
  S7_ETA_0->SetBinContent(15,2.858107714400028);
  S7_ETA_0->SetBinContent(16,10.003379000399898);
  S7_ETA_0->SetBinContent(17,24.798287522000244);
  S7_ETA_0->SetBinContent(18,64.22336358240042);
  S7_ETA_0->SetBinContent(19,123.99148760999621);
  S7_ETA_0->SetBinContent(20,193.4266806715981);
  S7_ETA_0->SetBinContent(21,191.15698089840066);
  S7_ETA_0->SetBinContent(22,128.69888713960347);
  S7_ETA_0->SetBinContent(23,60.86088391840039);
  S7_ETA_0->SetBinContent(24,23.537357648000228);
  S7_ETA_0->SetBinContent(25,8.910571109600086);
  S7_ETA_0->SetBinContent(26,3.4465416556000337);
  S7_ETA_0->SetBinContent(27,1.6812398320000164);
  S7_ETA_0->SetBinContent(28,0.4203099580000041);
  S7_ETA_0->SetBinContent(29,0.08406199160000082);
  S7_ETA_0->SetBinContent(30,0.16812398320000163);
