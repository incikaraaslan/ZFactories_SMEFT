void selection_8()
{
  ...
  S9_DELTAR_0->SetBinContent(13,44.14553743347036);
  S9_DELTAR_0->SetBinContent(14,22.147588712385303);
  S9_DELTAR_0->SetBinContent(15,6.9782235943006095);
  S9_DELTAR_0->SetBinContent(16,2.9771648269138353);
  S9_DELTAR_0->SetBinContent(17,1.1971669303992072);
  S9_DELTAR_0->SetBinContent(18,0.5985834651996036);
  S9_DELTAR_0->SetBinContent(19,0.3701766784786987);
  S9_DELTAR_0->SetBinContent(20,0.17327418992619936);
  S9_DELTAR_0->SetBinContent(21,0.06300878633680035);
  S9_DELTAR_0->SetBinContent(22,0.08663708496310026);
  S9_DELTAR_0->SetBinContent(23,0.007876098542100028);
  S9_DELTAR_0->SetBinContent(24,0.015752199084199944);
  ...
  stack->GetXaxis()->SetTitle("#DeltaR [ ta-_{1}, mu+_{1} ] ");
