...
C     
C     Process: z h > ta- mu+ NPcHe=0 NPcHl1=0 NPcHl3=0 NPceB<=1
C      NPceH=0 NPceW=0 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
...
C     Amplitude(s) for diagram number 1
      CALL FFVS3_7_0(W(1,4),W(1,3),W(1,1),W(1,2),GC_6208,GC_6210,AMP(1)
     $ )
      CALL VVS4P0_1(W(1,1),W(1,2),GC_6361,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV11_4_0(W(1,4),W(1,3),W(1,5),GC_6510,GC_6508,AMP(2))
      CALL VVS3_1(W(1,1),W(1,2),GC_6738,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV11_4_0(W(1,4),W(1,3),W(1,5),GC_7011,GC_7009,AMP(3))
      CALL FFV11_4_2(W(1,4),W(1,1),GC_7011,GC_7009,MDL_MTA, FK_ZERO
     $ ,W(1,5))
