...
C     
     ...
     $ * W1))
      V1(3)= DENOM*S3(3)*(-CI*(TMP1*P2(0))+CI*(V2(3)*TMP6))
      V1(4)= DENOM*S3(3)*(-CI*(TMP1*P2(1))+CI*(V2(4)*TMP6))
      V1(5)= DENOM*S3(3)*(-CI*(TMP1*P2(2))+CI*(V2(5)*TMP6))
      V1(6)= DENOM*S3(3)*(-CI*(TMP1*P2(3))+CI*(V2(6)*TMP6))
      END
