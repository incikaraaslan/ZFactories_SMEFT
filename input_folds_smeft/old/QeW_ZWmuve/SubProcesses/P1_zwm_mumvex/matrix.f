...
C     
C     Process: z w- > mu- ve~ NPcHe=0 NPcHl1=0 NPcHl3=0 NPceB=0
C      NPceH=0 NPceW<=1 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
...
C     Amplitude(s) for diagram number 1
      CALL FFVV2_0(W(1,4),W(1,3),W(1,2),W(1,1),GC_6944,AMP(1))
      CALL VVV5_1(W(1,2),W(1,1),GC_5911,MDL_MW, FK_MDL_WW,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV4_0(W(1,4),W(1,3),W(1,5),GC_6465,AMP(2))
      CALL FFV11_4_1(W(1,3),W(1,1),GC_6530,GC_6528,ZERO, FK_ZERO,W(1,5)
     $ )
C     Amplitude(s) for diagram number 3
      CALL FFV3_0(W(1,4),W(1,5),W(1,2),GC_5899,AMP(3))
      CALL FFV1_3_1(W(1,3),W(1,1),GC_6187,-GC_5909,ZERO, FK_ZERO,W(1,5)
     $ )
C     Amplitude(s) for diagram number 4
      CALL FFV4_0(W(1,4),W(1,5),W(1,2),GC_6465,AMP(4))
      CALL FFV3_2(W(1,4),W(1,1),GC_5909,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 5
      CALL FFV4_0(W(1,5),W(1,3),W(1,2),GC_6465,AMP(5))
