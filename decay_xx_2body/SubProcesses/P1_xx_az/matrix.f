...
C     COMMON/TO_HELICITY/  HEL_BUFF
      ...
      DATA (NHEL(I,   8),I=1,3) / 0,-1, 0/
      DATA (NHEL(I,   9),I=1,3) / 0,-1, 1/
      DATA (NHEL(I,  10),I=1,3) / 0, 1,-1/
      DATA (NHEL(I,  11),I=1,3) / 0, 1, 0/
      DATA (NHEL(I,  12),I=1,3) / 0, 1, 1/
      DATA (NHEL(I,  13),I=1,3) / 1,-1,-1/
      DATA (NHEL(I,  14),I=1,3) / 1,-1, 0/
      DATA (NHEL(I,  15),I=1,3) / 1,-1, 1/
      DATA (NHEL(I,  16),I=1,3) / 1, 1,-1/
      DATA (NHEL(I,  17),I=1,3) / 1, 1, 0/
      DATA (NHEL(I,  18),I=1,3) / 1, 1, 1/
      DATA IDEN/ 3/
C     ----------
C     BEGIN CODE
C     ----------
...
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(1,2),W(1,1),W(1,3),GC_246,AMP(1))
