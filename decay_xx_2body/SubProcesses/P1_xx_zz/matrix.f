...
C     COMMON/TO_HELICITY/  HEL_BUFF
      ...
      DATA (NHEL(I,   5),I=1,3) /-1, 0, 0/
      DATA (NHEL(I,   6),I=1,3) /-1, 0, 1/
      DATA (NHEL(I,   7),I=1,3) /-1, 1,-1/
      DATA (NHEL(I,   8),I=1,3) /-1, 1, 0/
      DATA (NHEL(I,   9),I=1,3) /-1, 1, 1/
      DATA (NHEL(I,  10),I=1,3) / 0,-1,-1/
      DATA (NHEL(I,  11),I=1,3) / 0,-1, 0/
      DATA (NHEL(I,  12),I=1,3) / 0,-1, 1/
      DATA (NHEL(I,  13),I=1,3) / 0, 0,-1/
      DATA (NHEL(I,  14),I=1,3) / 0, 0, 0/
      DATA (NHEL(I,  15),I=1,3) / 0, 0, 1/
      DATA (NHEL(I,  16),I=1,3) / 0, 1,-1/
      DATA (NHEL(I,  17),I=1,3) / 0, 1, 0/
      DATA (NHEL(I,  18),I=1,3) / 0, 1, 1/
      DATA (NHEL(I,  19),I=1,3) / 1,-1,-1/
      DATA (NHEL(I,  20),I=1,3) / 1,-1, 0/
      DATA (NHEL(I,  21),I=1,3) / 1,-1, 1/
      DATA (NHEL(I,  22),I=1,3) / 1, 0,-1/
      DATA (NHEL(I,  23),I=1,3) / 1, 0, 0/
      DATA (NHEL(I,  24),I=1,3) / 1, 0, 1/
      DATA (NHEL(I,  25),I=1,3) / 1, 1,-1/
      DATA (NHEL(I,  26),I=1,3) / 1, 1, 0/
      DATA (NHEL(I,  27),I=1,3) / 1, 1, 1/
      DATA IDEN/ 6/
C     ----------
C     BEGIN CODE
C     ----------
...
C     Amplitude(s) for diagram number 1
      CALL VVV3_0(W(1,1),W(1,2),W(1,3),GC_248,AMP(1))
