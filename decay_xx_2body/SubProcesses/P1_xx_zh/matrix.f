...
C     COMMON/TO_HELICITY/  HEL_BUFF
      ...
      DATA (NHEL(I,   2),I=1,3) /-1, 0, 0/
      DATA (NHEL(I,   3),I=1,3) /-1, 1, 0/
      DATA (NHEL(I,   4),I=1,3) / 0,-1, 0/
      DATA (NHEL(I,   5),I=1,3) / 0, 0, 0/
      DATA (NHEL(I,   6),I=1,3) / 0, 1, 0/
      DATA (NHEL(I,   7),I=1,3) / 1,-1, 0/
      DATA (NHEL(I,   8),I=1,3) / 1, 0, 0/
      DATA (NHEL(I,   9),I=1,3) / 1, 1, 0/
      DATA IDEN/ 3/
C     ----------
C     BEGIN CODE
C     ----------
...
C     Amplitude(s) for diagram number 1
      CALL VVS3_0(W(1,1),W(1,2),W(1,3),GC_184,AMP(1))
