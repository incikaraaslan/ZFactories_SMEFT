...
C     COMMON/TO_HELICITY/  HEL_BUFF
      ...
      DATA (NHEL(I,   2),I=1,3) /-1, 1, 1/
      DATA (NHEL(I,   3),I=1,3) /-1,-1,-1/
      DATA (NHEL(I,   4),I=1,3) /-1,-1, 1/
      DATA (NHEL(I,   5),I=1,3) / 0, 1,-1/
      DATA (NHEL(I,   6),I=1,3) / 0, 1, 1/
      DATA (NHEL(I,   7),I=1,3) / 0,-1,-1/
      DATA (NHEL(I,   8),I=1,3) / 0,-1, 1/
      DATA (NHEL(I,   9),I=1,3) / 1, 1,-1/
      DATA (NHEL(I,  10),I=1,3) / 1, 1, 1/
      DATA (NHEL(I,  11),I=1,3) / 1,-1,-1/
...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL IXXXXX(P(0,2),MDL_MMU,NHEL(2),-1*IC(2),W(1,2))
      CALL OXXXXX(P(0,3),MDL_ME,NHEL(3),+1*IC(3),W(1,3))
C     Amplitude(s) for diagram number 1
      CALL FFV3_0(W(1,2),W(1,3),W(1,1),GC_7262,AMP(1))
C     Amplitude(s) for diagram number 2
      CALL FFV6_0(W(1,2),W(1,3),W(1,1),GC_7250,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL FFV11_4_0(W(1,2),W(1,3),W(1,1),GC_6514,GC_6517,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV3_0(W(1,2),W(1,3),W(1,1),GC_7269,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV6_0(W(1,2),W(1,3),W(1,1),GC_7257,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV11_4_0(W(1,2),W(1,3),W(1,1),GC_6528,GC_6530,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV3_0(W(1,2),W(1,3),W(1,1),GC_7274,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV11_4_0(W(1,2),W(1,3),W(1,1),GC_6991,GC_6994,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFV3_0(W(1,2),W(1,3),W(1,1),GC_7281,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV11_4_0(W(1,2),W(1,3),W(1,1),GC_7005,GC_7007,AMP(10))
